...
<body>
    ...
    <form id="sumaForm" method="post" action="">
        <input type="number" name="liczba1" placeholder="Pierwsza liczba" id="suma_liczba1" required>
        <input type="number" name="liczba2" placeholder="Druga liczba" id="suma_liczba2" required>
        <button type="submit" name="suma">Oblicz sumę</button>
    </form>
    
    <form id="roznicaForm" method="post" action="">
        <input type="number" name="liczba1" placeholder="Pierwsza liczba" id="roznica_liczba1" required>
        <input type="number" name="liczba2" placeholder="Druga liczba" id="roznica_liczba2" required>
